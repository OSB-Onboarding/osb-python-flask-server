...
def service_binding_binding(X_Broker_API_Version, instance_id, binding_id, body, X_Broker_API_Originating_Identity=None, X_Broker_API_Request_Identity=None, accepts_incomplete=None):  # noqa: E501
...
def service_binding_get(X_Broker_API_Version, instance_id, binding_id, X_Broker_API_Originating_Identity=None, X_Broker_API_Request_Identity=None, service_id=None, plan_id=None):  # noqa: E501
...
def service_binding_last_operation_get(X_Broker_API_Version, instance_id, binding_id, X_Broker_API_Originating_Identity=None, X_Broker_API_Request_Identity=None, service_id=None, plan_id=None, operation=None):  # noqa: E501
...
def service_binding_unbinding(X_Broker_API_Version, instance_id, binding_id, service_id, plan_id, X_Broker_API_Originating_Identity=None, X_Broker_API_Request_Identity=None, accepts_incomplete=None):  # noqa: E501
